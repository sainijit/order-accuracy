...
# LAZY LOADING with file lock to prevent race conditions
reader = None
OCR_LOCK_FILE = "/tmp/easyocr_init.lock"

def _ensure_reader():
    """Lazy initialize EasyOCR with file locking."""
    global reader
